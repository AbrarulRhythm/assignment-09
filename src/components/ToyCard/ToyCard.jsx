...
const ToyCard = ({ toy }) => {
    ...
    return (
        <div className='w-full md:w-6/12 lg:w-3/12 px-2 mb-6'>
            <div className='group hover:-translate-y-2 duration-300 bg-white h-full rounded-md shadow'>
                ...
                <div className='p-4'>
                    <h3 className='text-[18px] font-semibold text-dark-1 mb-2'>{toyName}</h3>
                    ...
                    <div className='text-sm availableQuantity font-medium flex items-center relative mb-3'>
                        <div>
                    ...
                    <Link to={`/product/${toyId}`} className='inline-block text-white py-2.5 px-10 w-full text-sm text-center rounded-md bg-primary-theme hover:bg-primary-theme-dark duration-300'>View Details</Link>
                </div>
            </div>
        </div>
    );
